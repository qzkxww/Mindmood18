/*
  ...
  1. New Tables
    - `user_profiles`
      ...
      - `assessment_results` (jsonb, stores onboarding quiz results)
      - `personalized_plan` (text, stores the generated plan name)
...
CREATE TABLE IF NOT EXISTS user_profiles (
  ...
  full_name text,
  avatar_url text,
  plan_type text DEFAULT 'free' CHECK (plan_type IN ('free', 'premium', 'yearly')),
